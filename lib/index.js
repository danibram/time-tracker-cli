...
module.exports = function createTimer(p) {
    ...
    if (_commander2.default.start) {
        ...
        (0, _Output.sumarize)(_commander2.default.report, _Manager2.default.search(_commander2.default.report), _commander2.default.args[0], true);
