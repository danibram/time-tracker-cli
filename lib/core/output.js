...
var sumarize = exports.sumarize = function sumarize(search, tasks, rate, full, format) {
    ...
    tasks.forEach(function (task, index) {
        ...
        var description = task.description() && task.description() !== '' ? task.description() : task.name;
    ...
    if (full) {
        table.push([]);
        table.push([{ rowSpan: 2, content: _colors2.default.red('Search:') + ' "' + search + '"', vAlign: 'center' }, _colors2.default.red('Total time'), (0, _utils.humanParseDiff)(total)]);

        if (rate) {
            table.push([_colors2.default.red('Rate'), (0, _utils.calcRate)(rate, total)]);
        }
    }
